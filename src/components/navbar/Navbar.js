...
export const Navbar = () => {
    return (
        <>
            <nav class=" bg-transparent navbar flex w-full gap-2 shadow max-md:flex-col md:items-center">
                ...
                <div id="default-navbar-collapse" class="md:navbar-end collapse hidden grow basis-full overflow-hidden transition-[height] duration-300 max-md:w-full  ">
                    <ul class="bg-transparent w-100 menu md:menu-horizontal gap-2 md:gap-2 lg:gap-4 xl:gap-4 p-0 text-base columns-3xs">
                        ...
                        <li><a href="#" className="bg-white text-black hover:text-white focus:text-white active:text-white w-100 text-xs sm:text-xs md:text-xs lg:text-base xl:text-base">contactame</a></li>
                    </ul>
                </div>
            </nav>
        </>
