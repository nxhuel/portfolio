...
export const SectionPresentation = () => {
    return (
        <>
            ...
            <div className=" container flex flex-col">
                <div>
                    <div className="text-start font-bold text-3xl sm:text-5xl pt-10 pl-10 pr-10 text-black">
                        Analista de sistemas | Backend Dev.
                    </div>
                    <div className="  text-start pt-2 sm:pt-10 pl-10 pr-10">
                        <h2 style={{ userSelect: 'none'}} className="text-2xl sm:text-4xl text-black">
                            <ReactTyped
                                strings={[
                                    'API RESTfull',
                                    'Gestión de base de datos',
